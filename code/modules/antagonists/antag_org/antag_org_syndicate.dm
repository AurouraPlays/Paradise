...
/datum/antag_org/syndicate/faid // Targets one syndicate agent and steal station intel.
	...
	unique_targets = list(/datum/objective/unique_objective/plant_malware/hack_rnd, /datum/objective/unique_objective/plant_malware/hack_tcomms,
		/datum/objective/unique_objective/plant_malware/hack_pda, /datum/objective/unique_objective/plant_malware/hack_cc_comms, /datum/objective/unique_objective/plant_malware/hack_blackbox)
	chaos_level = ORG_CHAOS_HUNTER
